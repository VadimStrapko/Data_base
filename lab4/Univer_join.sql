...
--ex3--
select FACULTY.FACULTY as Факультет, PULPIT.PULPIT as Кафедра, PROFESSION.PROFESSION as Специальность,SUBJECT.SUBJECT as Дисциплина,STUDENT.NAME as [Имя Студента],
	case
